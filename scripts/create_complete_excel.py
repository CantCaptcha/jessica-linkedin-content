#!/usr/bin/env python3
"""
Complete NIST-CMMC Artifacts spreadsheet with all 6 sheets
"""
...
# SHEET 4: Level 2 Artifacts (Additional)
...
data4 = [
    ...
    ['SI', 'SI.1.001', 'Flaw Remediation', '3.14.1', 'Vulnerability Management Policy, Patch Management Procedures, Vulnerability ID Logs, Patch Deployment Schedules, Root Cause Analysis'],
    ...
    ['SI', 'SI.1.003', 'Security Baseline Updates', '3.14.3', 'Security Baseline Update Schedule, Baseline Version Control, Baseline Approval Documentation, Update Notifications, Deployment Records'],
...
print("Sheets:")
print("  1. Overview")
print("  2. Domain Comparison")
print("  3. Level 1 Artifacts (17 controls)")
print("  4. Level 2 Artifacts (72 controls)")
print("  5. Critical Documents")
print("  6. Implementation Roadmap (11 phases)")
